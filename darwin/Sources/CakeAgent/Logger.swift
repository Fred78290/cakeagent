...
public struct Logger: Sendable {
	...
	let label = "com.aldunelabs.cakeagent"
	var logger: Logging.Logger

	public init(_ target: Any) {
		let thisType = type(of: target)
		self.logger = Logging.Logger(label: "com.aldunelabs.cakeagent.\(String(describing: thisType))")
		self.logger.logLevel = Self.logLevel
	}

	public init(_ label: String) {
		self.logger = Logging.Logger(label: "com.aldunelabs.cakeagent.\(label)")
		self.logger.logLevel = Self.logLevel
	}
